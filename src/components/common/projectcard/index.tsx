	...
	return (
		<StyledProjectcard>
			...
			<div style={{ display: "flex", gap: "12px" }}>
				{props.link && (
					<Link href={props.link} style={{ textDecoration: "none", color: "black", display: "flex" }}>
						<StyledLinkItem>
				...
				{props.gitlink && (
					<Link href={props.gitlink} style={{ textDecoration: "none", color: "black", display: "flex" }}>
						<StyledLinkItem>
				...
				{props.postlink && (
					<Link href={props.postlink} style={{ textDecoration: "none", color: "black", display: "flex" }}>
						<StyledLinkItem>
